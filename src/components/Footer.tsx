export default function Footer() {
  return (
    <footer className="w-full bg-slate-950 text-white pt-16 pb-8 px-6 border-t-4 border-yellow-500 z-50 relative mt-auto">
      ...
      <div className="border-t border-slate-800 max-w-6xl mx-auto mt-8 pt-8 text-center md:text-left flex justify-between">
         <p className="text-slate-500 text-sm font-medium">© 2026 HOL 2027. All Rights Reserved.</p>
         <p className="text-slate-600 text-xs">Powered by the People</p>
      </div>
    </footer>
  );
}
